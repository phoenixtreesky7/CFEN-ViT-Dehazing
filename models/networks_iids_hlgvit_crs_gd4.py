...
class dec_ipt(nn.Module):
    ...
    def forward(self, input):
        ...
        d_d_02_in = self.sk_conv_d03d(torch.cat((d_d_03_us, s_d_03_us),1))
        ...
        d_d_01_in = self.sk_conv_d02d(torch.cat((d_d_02_us, s_d_02_us),1))
        ...
        #xdh_temp[:,1,:,:] = xr[:,1,:,:]*xs
        #xdh_temp[:,2,:,:] = xr[:,2,:,:]*xs
        xdh = self.sp(torch.cat((input, xs, xd),1))
