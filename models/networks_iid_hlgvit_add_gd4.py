...
class dec_ipt(nn.Module):
    ...
    def forward(self, input):
        ...
        # Merge the Local ViT and Global ViT, and downscaling
        x_e_02 = x_lve_02 + x_gve_02 + x_e_01_ds
        ...
        x_e_03 = x_lve_03 + x_gve_03 + x_e_02_ds
        ...
        r_d_03 = r_lvd_03, + r_gvd_03 + r_d_03_in
        ...
        # Merge the Local ViT and Global ViT, and upscaling
        r_d_02 = r_lvd_02 + r_gvd_02 + r_d_02_in
        ...
        # Merge the Local ViT and Global ViT, and downscaling
        r_d_01 = r_lvd_01 + r_gvd_01 + r_d_01_in
        ...
        # Merge the Local ViT and Global ViT, and upscaling
        s_d_03 = s_lvd_03 + s_gvd_03 + s_d_03_in
        ...
        # Merge the Local ViT and Global ViT, and upscaling
        s_d_02 = s_lvd_02, + s_gvd_02 + s_d_02_in
        ...
        # Merge the Local ViT and Global ViT, and downscaling
        s_d_01 = s_lvd_01 + s_gvd_01 + s_d_01_in
        ...
        # Merge the Local ViT and Global ViT, and upscaling
        d_d_03 = d_lvd_03 + d_gvd_03 + d_d_03_in
        ...
        # Merge the Local ViT and Global ViT, and upscaling
        d_d_02 = d_lvd_02 + d_gvd_02 + d_d_02_in
        ...
        # Merge the Local ViT and Global ViT, and downscaling
        d_d_01 = d_lvd_01 + d_gvd_01 + d_d_01_in
